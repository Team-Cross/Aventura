...
void MNIST_Parser::ReadMNIST_Input(string filename,int num_images, float** inputs)
{
...
void MNIST_Parser::ReadMNIST_Label(string filename,int num_labels, float** outputs)
{
...
int MNIST_Parser::BytetoInt(int byte) // Byte(size by 4) to Int
{
